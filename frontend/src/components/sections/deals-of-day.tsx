  ...
  return (
    <div className="relative group bg-white border border-border-gray-alt rounded-lg p-4 flex flex-col justify-between shadow-sm hover:shadow-lg transition-shadow duration-300">
      <div>
        ...
        <div
          className="block aspect-square overflow-hidden rounded-md mb-4 cursor-pointer"
      ...
      <div className="flex mt-4 items-center gap-2">
        ...
        <button 
          ...
          className="flex-1 bg-primary-green text-white py-2.5 rounded-md text-sm font-semibold uppercase tracking-wider hover:bg-[#0a3d31] transition-colors duration-300 cursor-pointer"
        >
          Add
        </button>
