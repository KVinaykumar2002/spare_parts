...
export const staticBannersHero: StaticBanner[] = [
  ...
  { _id: 'banner-hero-5', title: 'Anandh Bunk Stores', subtitle: 'Visit Us', image: `${HERO_IMAGES_DIR}/5.png`, link: '/', position: 'hero', order: 2 },
  { _id: 'banner-hero-6', title: 'Anandh Bunk Stores', subtitle: 'Shop Now', image: `${HERO_IMAGES_DIR}/6.png`, link: '/', position: 'hero', order: 1 },
];
